...
export default function Register() {
  ...
  // Helper function to save roadmap after successful registration
  ...
  // Handle Google Sign-In (also works for registration)
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/popup-closed-by-user') {
        setLocalError('Sign-up popup was closed. Please try again.');
      } else if (error.code === 'auth/cancelled-popup-request') {
        setLocalError('Sign-up was cancelled. Please try again.');
      } else {
